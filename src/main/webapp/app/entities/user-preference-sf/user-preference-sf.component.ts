...
@Component({
    selector: 'sf-user-preference-sf',
    templateUrl: './user-preference-sf.component.html'
})
export class UserPreferenceSfComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.userPreferenceService
            ...
            .subscribe(
                (res: HttpResponse<IUserPreferenceSf[]>) => this.paginateUserPreferences(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/user-preference-sf'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: IUserPreferenceSf) {
        return item.id;
    }
    ...
    private paginateUserPreferences(data: IUserPreferenceSf[], headers: HttpHeaders) {
