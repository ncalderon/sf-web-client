...
@Component({
    selector: 'sf-tran-category-sf',
    templateUrl: './tran-category-sf.component.html'
})
export class TranCategorySfComponent implements OnInit, OnDestroy {
    currentAccount: any;
    ...
    loadAll() {
        this.tranCategoryService
            ...
            .subscribe(
                (res: HttpResponse<ITranCategorySf[]>) => this.paginateTranCategories(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/tran-category-sf'], {
            queryParams: {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: ITranCategorySf) {
        return item.id;
    }
    ...
    private paginateTranCategories(data: ITranCategorySf[], headers: HttpHeaders) {
