...
public class SfWebClientApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(SfWebClientApp.class);

    private final Environment env;

    public SfWebClientApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes sf_web_client.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(SfWebClientApp.class);
