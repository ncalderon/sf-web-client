...
import { CurrencySfComponent } from 'app/entities/currency-sf/currency-sf.component';
...
describe('Component Tests', () => {
    describe('CurrencySf Management Component', () => {
        let comp: CurrencySfComponent;
        let fixture: ComponentFixture<CurrencySfComponent>;
        let service: CurrencySfService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [SfwebTestModule],
                declarations: [CurrencySfComponent],
                providers: [
                    {
                ...
                .overrideTemplate(CurrencySfComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(CurrencySfComponent);
