...
import { PreferenceSfComponent } from 'app/entities/preference-sf/preference-sf.component';
...
describe('Component Tests', () => {
    describe('PreferenceSf Management Component', () => {
        let comp: PreferenceSfComponent;
        let fixture: ComponentFixture<PreferenceSfComponent>;
        let service: PreferenceSfService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [SfwebTestModule],
                declarations: [PreferenceSfComponent],
                providers: [
                    {
                ...
                .overrideTemplate(PreferenceSfComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(PreferenceSfComponent);
