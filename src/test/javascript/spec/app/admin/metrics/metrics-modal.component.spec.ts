...
import { SfMetricsMonitoringModalComponent } from 'app/admin/metrics/metrics-modal.component';
import { SfMetricsService } from 'app/admin/metrics/metrics.service';

describe('Component Tests', () => {
    describe('SfMetricsMonitoringModalComponent', () => {
        let comp: SfMetricsMonitoringModalComponent;
        let fixture: ComponentFixture<SfMetricsMonitoringModalComponent>;
        let service: SfMetricsService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [SfwebTestModule],
                declarations: [SfMetricsMonitoringModalComponent]
            })
                .overrideTemplate(SfMetricsMonitoringModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(SfMetricsMonitoringModalComponent);
